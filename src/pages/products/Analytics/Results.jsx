      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-7 w-full max-w-7xl'>
        ...
        >
          ...
          <div className='flex items-center justify-between'>
            <span className='text-lg font-medium text-[#30C1A0]'>Coverage</span>
        ...
        >
          ...
          <div className='flex items-center justify-between'>
            <span className='text-lg font-medium text-[#30C1A0]'>Satisfaction</span>
            <div className='flex items-center gap-2'>
              <div className='h-2 w-2 bg-gray-400 rounded-full' />
              <div className='h-2 w-2 bg-black rounded-full' />
              <div className='h-2 w-2 bg-gray-400 rounded-full' />
        ...
        >
          ...
          <div className='flex items-center justify-between'>
            <span className='text-lg font-medium text-[#30C1A0]'>Efficiency</span>
            <div className='flex items-center gap-2'>
              <div className='h-2 w-2 bg-gray-400 rounded-full' />
              <div className='h-2 w-2 bg-gray-400 rounded-full' />
              <div className='h-2 w-2 bg-black rounded-full' />
