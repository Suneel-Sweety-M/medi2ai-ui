...
const Hero = () => {
  ...
  return (
    <div 
      ref={sectionRef}
      className=" py-7 flex flex-col items-center justify-center  text-black  px-4 sm:px-6 md:px-10 mt-20"
    >
      <div className="flex flex-col lg:flex-row items-center gap-8 w-full ">
        ...
        <div className="lg:w-1/2">
          <div className="text-start">
            ...
            >
              Accelerate value-based success with{' '}
              <span className="text-[#30C1A0]">real-time</span> analytics
            </h1>
            <p 
              ref={subtitleRef}
        ...
        {/* Image Content */}
        <div className="lg:w-1/2">
          <div className="bg-white p-5 rounded-3xl overflow-hidden">        
              <img 
              ref={imageRef}
              src='/analytics.jpg' 
