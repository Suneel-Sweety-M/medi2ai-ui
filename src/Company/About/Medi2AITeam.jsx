...
const Medi2AITeam = () => {
  ...
  const teamMembers = [
    {
      ...
      bio: 'Experienced leader with a vision for transforming healthcare through AI. Previously founded two successful health tech startups.',
      image: getTeamMemberImage(1),
    },
    {
      id: 2,
      name: 'Stay Power',
      title: 'CTO & Co-Founder',
      bio: 'Technology expert with 15+ years in AI development. Holds patents in machine learning applications for medical diagnostics.',
      image: getTeamMemberImage(2),
    },
    {
      id: 3,
      name: 'Yet Lens, MD, PhD',
      title: 'Chief Medical Officer',
      bio: 'Board-certified physician and researcher with expertise in clinical AI applications. Former professor at leading medical school.',
      image: getTeamMemberImage(3),
    },
    {
      id: 4,
      name: 'Marz Allen',
      title: 'Chief Business Development Officer',
      bio: 'Strategic partnerships expert with extensive network in healthcare and technology sectors. Instrumental in scaling multiple startups.',
      image: getTeamMemberImage(4),
    },
    {
      id: 5,
      name: 'Dan McCaffay',
      title: 'VP of Value-Based Care',
      bio: 'Pioneer in value-based care models with focus on AI-driven patient outcomes. Previously led care innovation at major health system.',
      image: getTeamMemberImage(5),
    },
    {
      id: 6,
      name: 'Kit Ovat, PhD',
      title: 'Chief Strategy Officer',
      bio: 'Data scientist and strategist specializing in healthcare AI implementation. Authored several books on medical technology adoption.',
      image: getTeamMemberImage(6),
    },
    {
      id: 7,
      name: 'Anna Austin',
      title: 'Chief Marketing Officer',
      bio: 'Brand builder with expertise in health tech marketing. Led successful campaigns for multiple FDA-approved digital health products.',
      image: getTeamMemberImage(7),
    },
    {
      id: 8,
      name: 'Olad Buntain',
      title: 'Chief Financial Officer',
      bio: 'Finance executive with background in healthcare investments and startup funding. Managed IPOs and acquisitions for tech companies.',
      image: getTeamMemberImage(8),
    },
    {
      id: 9,
      name: 'Shany Kusel',
      title: 'VP of People',
      bio: 'Human resources innovator focused on building culture in high-growth health tech companies. Developed industry-leading talent programs.',
      image: getTeamMemberImage(9),
    },
    {
      id: 10,
      name: 'Yed Tazi',
      title: 'President',
      bio: 'Seasoned executive with a track record of leading companies through rapid growth phases. Specializes in operational excellence.',
      image: getTeamMemberImage(10),
    },
  ];
  ...
  return (
    <div ref={sectionRef} className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Meet the visionaries driving innovation in healthcare AI, transforming patient outcomes through cutting-edge technology.
          </p>
        </div>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 transition-all duration-1000 delay-300 ${
          ...
          {[
            ...
            <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 text-center transform hover:scale-105 transition-transform duration-300">
              <div className="text-3xl font-bold text-black-400 mb-2">{stat.number}</div>
              ...
              <div className="relative w-full h-full transition-transform duration-500 transform-style-preserve-3d group-hover:rotate-y-180">
                ...
                <div className="absolute w-full h-full backface-hidden bg-white rounded-xl shadow-lg border border-teal-100 flex flex-col overflow-hidden">
                  ...
                  <div className="p-6 text-center flex-grow flex flex-col justify-center">
                    ...
                    <p className="text-[#30C1A0] mt-1 font-medium">{member.title}</p>
                    ...
                    <p className="text-sm text-gray-500 mt-4 animate-pulse">Hover to learn more</p>
                  </div>
                </div>
        ...
        <div className={`text-center mt-16 p-8 bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl shadow-xl transition-all duration-1000 delay-500 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Be part of the revolution in healthcare AI. We're always looking for talented individuals to join our mission.
          </p>
